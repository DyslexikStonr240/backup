...
mnist_dataset_reader::mnist_dataset_reader(std::string path_to_extracted_mnist_files){
    ...
    cout << endl;
    train_images = read_mnist_images( path_to_extracted_mnist_files + "/" + "train-images.idx3-ubyte", nr_train_images_read, size_of_image);
    ...
    cout << endl;
    test_images = read_mnist_images(path_to_extracted_mnist_files + "/" + "t10k-images.idx3-ubyte", nr_test_images_read, size_of_image);
...
int                 mnist_dataset_reader::get_nr_train_images_read(){
    return nr_train_images_read;
}

int                 mnist_dataset_reader::get_nr_test_images_read(){
    return nr_test_images_read;
}

int                 mnist_dataset_reader::get_size_of_image(){
...
// Must delete mat object after use
...
mnist_dataset_reader::~mnist_dataset_reader(){
    //Free each sub-array
    for(int i = 0; i < nr_train_images_read; ++i) {
    ...
    //Free each sub-array
    for(int i = 0; i < nr_test_images_read; ++i) {
